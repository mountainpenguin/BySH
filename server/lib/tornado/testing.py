...
try:
    from lib.tornado import gen
    from lib.tornado.httpclient import AsyncHTTPClient
    from lib.tornado.httpserver import HTTPServer
    from lib.tornado.simple_httpclient import SimpleAsyncHTTPClient
    from lib.tornado.ioloop import IOLoop
    from lib.tornado import netutil
except ImportError:
...
from lib.tornado.stack_context import ExceptionStackContext
from lib.tornado.util import raise_exc_info, basestring_type
import functools
import logging
import os
import re
...
def main(**kwargs):
    ...
    """
    from lib.tornado.options import define, options, parse_command_line
