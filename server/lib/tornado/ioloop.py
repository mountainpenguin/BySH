...
from lib.tornado.concurrent import Future, TracebackFuture
from lib.tornado.log import app_log, gen_log
...
from lib.tornado.platform.auto import set_close_exec, Waker
...
class IOLoop(Configurable):
    ...
    def configurable_default(cls):
        if hasattr(select, "epoll"):
            from lib.tornado.platform.epoll import EPollIOLoop
            return EPollIOLoop
        if hasattr(select, "kqueue"):
            # Python 2.6+ on BSD or Mac
            from lib.tornado.platform.kqueue import KQueueIOLoop
            return KQueueIOLoop
        from lib.tornado.platform.select import SelectIOLoop
        return SelectIOLoop
